    ...
    <div class="container p-3">
        <div class="row">
            ...
            <div class="col-3">
                ...
                <ul>
                    <li>
                        <a href="dashboard.php" class="text-danger">Posts</a>
                    </li>
                    <li>
                ...
                <div class="container">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" placeholder="Enter title" class="form-control" id="" value="<?php echo $result["title"] ?>">
                        </div>
                        </div>
                            <div class="col-6">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            <button type="submit" name="update_post" style="background-color:#d16943;" class="btn btn-sm text-white my-2">
                                Update</button>
                        </div>
                </div>
                </form>
